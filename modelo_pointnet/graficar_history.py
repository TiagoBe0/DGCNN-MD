...
# Añadir línea en el mínimo de validación
...
plt.legend()
plt.grid(True, alpha=0.3)
# Añadir línea en el máximo de validación
...
# Crear un gráfico adicional de zoom en las últimas épocas
fig2, (ax1, ax2) = plt.subplots(1, 2, figsize=(14, 5))

# Determinar cuántas épocas mostrar (último 25%)
zoom_start = int(len(epochs) * 0.75)
zoom_epochs = epochs[zoom_start:]

# Gráfico de zoom: Pérdida
